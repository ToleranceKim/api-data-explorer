# 18. 축제 목록 조회 (prffestService) - 페이지 반복 수집 예시
import requests
import pandas as pd
import xmltodict
import os
...
def collect_prffest_list(
    ...
    """
    18. 축제 목록 조회(prffestService) - 모든 페이지(cpage)를 반복 수집하여 DataFrame 병합
    ...
    for page in range(1, max_pages + 1):
        ...
        for item in items:
            page_records.append({
                ...
                "festival":   item.get("festival")    # 축제여부
            })
